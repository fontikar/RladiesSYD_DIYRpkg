...
Please note 🚩: some of the explanations are heavily borrowed from Hadley Wickham and Jenny Byran's book - ["R Packages: Oragnise, Test Document and Share your Code"](https://r-pkgs.org/index.html) which is open access! This is my go-to reference if I have a question about package development, highly recommended! ⭐️⭐️⭐️⭐️⭐️
...
**You can either copy the contents of the `roxygen_template.R` and paste above the `say()` function your `say.R`**
...
Knit your README for a preview! 
...
**Copy and paste the contents of `test-say.R` into your empty script**
...
### AND THATS IT FOLKS! You have yourself an R package! 🥳🥳🥳
